...
public class OkHttpAsyncHttpClient implements HttpClient {
    ...
    /**
     * Converts the given unisoft-core request to okhttp request.
     *
     * @param request the unisoft-core request
    ...
    private static Mono<RequestBody> toOkHttpRequestBody(Flux<ByteBuffer> bbFlux, HttpHeaders headers) {
        Mono<ByteString> bsMono = bbFlux == null
    ...
    private static class OkHttpResponse extends HttpResponse {
        ...
        /**
         * Creates unisoft-core HttpHeaders from okhttp headers.
         *
         * @param headers okhttp headers
         * @return unisoft-core HttpHeaders
         */
        ...
        public Mono<String> getBodyAsString() {
            return getBodyAsByteArray()
                    .map(bytes -> CoreUtil.bomAwareToString(bytes, headers.getValue("Content-Type")));
        }
